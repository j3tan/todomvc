...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AllTodos = __webpack_require__(225);

	var _AllTodos2 = _interopRequireDefault(_AllTodos);

	var _ActiveTodos = __webpack_require__(236);

	var _ActiveTodos2 = _interopRequireDefault(_ActiveTodos);

	var _CompletedTodos = __webpack_require__(237);
	...
	(0, _reactDom.render)(_react2.default.createElement(
		...
		_react2.default.createElement(
			_reactRouter.Route,
			{ path: '/', component: App },
			_react2.default.createElement(_reactRouter.IndexRoute, { component: _AllTodos2.default }),
			_react2.default.createElement(_reactRouter.Route, { path: 'active', component: _ActiveTodos2.default }),
			_react2.default.createElement(_reactRouter.Route, { path: 'completed', component: _CompletedTodos2.default })
		)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoListApp = __webpack_require__(226);
	...
	var AllTodos = function (_Component) {
		_inherits(AllTodos, _Component);

		function AllTodos() {
			_classCallCheck(this, AllTodos);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(AllTodos).apply(this, arguments));
		}

		_createClass(AllTodos, [{
			key: 'render',
			value: function render() {

				return _react2.default.createElement(_TodoListApp2.default, { nowShowing: _constants.ALL_TODOS });
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoHeader = __webpack_require__(227);

	var _TodoHeader2 = _interopRequireDefault(_TodoHeader);

	var _TodoBody = __webpack_require__(228);

	var _TodoBody2 = _interopRequireDefault(_TodoBody);

	var _TodoFooter = __webpack_require__(233);

	var _TodoFooter2 = _interopRequireDefault(_TodoFooter);

	var _TodoStore = __webpack_require__(235);
	...
	var TodoListApp = function (_Component) {
		...
		function TodoListApp(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoListApp).call(this, props));

			_this.store = new _TodoStore2.default('react-es6-todos');
			_this.state = {
				todos: _this.store.todos
			};
			_this.store.subscribe(_this.updateTodos.bind(_this));
			return _this;
		}
		...
		_createClass(TodoListApp, [{
			...
			value: function render() {
				...
				var allTodosActive = activeTodoCount === todos.length;
				...
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_TodoHeader2.default, { store: this.store }),
					_react2.default.createElement(_TodoBody2.default, { todos: shownTodos, allTodosActive: allTodosActive, store: this.store }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoBody = function (_Component) {
		...
		function TodoBody(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoBody).call(this, props));
		...
		_createClass(TodoBody, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_TodoList2.default, { todos: todos, store: this.props.store })
				);
			}
		}]);
	   ...
	   */
			...
			value: function componentDidUpdate(prevProps) {
				if (!prevProps.editing && this.props.editing) {
					var node = (0, _reactDom.findDOMNode)(this.refs.editField);
					node.focus();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoFooter = function (_Component) {
		...
		function TodoFooter(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoFooter).call(this, props));
		...
		_createClass(TodoFooter, [{
			...
			value: function render() {
				...
				var activeTodoWord = (0, _utils.pluralize)(this.props.count, 'item');
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								{
									href: '#/',
									className: (0, _classnames2.default)({ selected: nowShowing === _constants.ALL_TODOS }) },
								'All'
							)
						),
						' ',
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								{
									href: '#/active',
									className: (0, _classnames2.default)({ selected: nowShowing === _constants.ACTIVE_TODOS }) },
								'Active'
							)
						),
						' ',
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								{
									href: '#/completed',
									className: (0, _classnames2.default)({ selected: nowShowing === _constants.COMPLETED_TODOS }) },
								'Completed'
							)
						)
					),
	...
	var TodoStore = function () {
		...
		_createClass(TodoStore, [{
			...
			value: function inform() {
				(0, _utils.store)(this.key, this.todos);
			...
			value: function toggleAll(checked) {
				...
				this.todos = this.todos.map(function (todo) {
					return (0, _utils.extend)({}, todo, { completed: checked });
				});
			...
			value: function toggle(todoToToggle) {
				this.todos = this.todos.map(function (todo) {
					return todo !== todoToToggle ? todo : (0, _utils.extend)({}, todo, { completed: !todo.completed });
				});
			...
			value: function save(todoToSave, text) {
				this.todos = this.todos.map(function (todo) {
					return todo !== todoToSave ? todo : (0, _utils.extend)({}, todo, { title: text });
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActiveTodos = function (_Component) {
		_inherits(ActiveTodos, _Component);

		function ActiveTodos() {
			_classCallCheck(this, ActiveTodos);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ActiveTodos).apply(this, arguments));
		}

		_createClass(ActiveTodos, [{
			key: 'render',
			value: function render() {

				return _react2.default.createElement(_TodoListApp2.default, { nowShowing: _constants.ACTIVE_TODOS });
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CompletedTodos = function (_Component) {
		_inherits(CompletedTodos, _Component);

		function CompletedTodos() {
			_classCallCheck(this, CompletedTodos);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(CompletedTodos).apply(this, arguments));
		}

		_createClass(CompletedTodos, [{
			key: 'render',
			value: function render() {

				return _react2.default.createElement(_TodoListApp2.default, { nowShowing: _constants.COMPLETED_TODOS });
			}
		}]);
